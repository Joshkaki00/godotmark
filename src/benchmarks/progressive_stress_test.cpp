...
void ProgressiveStressTest::_bind_methods() {
    ClassDB::bind_method(D_METHOD("start_test", "test_duration"), &ProgressiveStressTest::start_test, DEFVAL(60.0f));
    ClassDB::bind_method(D_METHOD("stop_test"), &ProgressiveStressTest::stop_test);
    ClassDB::bind_method(D_METHOD("reset_test"), &ProgressiveStressTest::reset_test);
    
    ClassDB::bind_method(D_METHOD("set_max_load", "load"), &ProgressiveStressTest::set_max_load);
    ClassDB::bind_method(D_METHOD("get_max_load"), &ProgressiveStressTest::get_max_load);
    ClassDB::bind_method(D_METHOD("set_ramp_rate", "rate"), &ProgressiveStressTest::set_ramp_rate);
    ClassDB::bind_method(D_METHOD("get_ramp_rate"), &ProgressiveStressTest::get_ramp_rate);
    
    ClassDB::bind_method(D_METHOD("set_quick_test_mode", "enabled", "duration"), &ProgressiveStressTest::set_quick_test_mode, DEFVAL(10.0f));
    ClassDB::bind_method(D_METHOD("get_quick_test_mode"), &ProgressiveStressTest::get_quick_test_mode);
    ClassDB::bind_method(D_METHOD("set_verbose_logging", "enabled"), &ProgressiveStressTest::set_verbose_logging);
    ClassDB::bind_method(D_METHOD("get_verbose_logging"), &ProgressiveStressTest::get_verbose_logging);
    
    ClassDB::bind_method(D_METHOD("get_is_running"), &ProgressiveStressTest::get_is_running);
    ClassDB::bind_method(D_METHOD("get_is_complete"), &ProgressiveStressTest::get_is_complete);
    ClassDB::bind_method(D_METHOD("get_elapsed_time"), &ProgressiveStressTest::get_elapsed_time);
    ClassDB::bind_method(D_METHOD("get_progress"), &ProgressiveStressTest::get_progress);
    
    ClassDB::bind_method(D_METHOD("get_current_load"), &ProgressiveStressTest::get_current_load);
    ClassDB::bind_method(D_METHOD("get_load_percentage"), &ProgressiveStressTest::get_load_percentage);
    ClassDB::bind_method(D_METHOD("get_peak_load"), &ProgressiveStressTest::get_peak_load);
    ClassDB::bind_method(D_METHOD("get_status"), &ProgressiveStressTest::get_status);
}
...
void ProgressiveStressTest::start_test(float test_duration) {
    ...
    if (quick_test_mode) {
        UtilityFunctions::print("[ProgressiveStressTest] Starting QUICK TEST (", duration, " seconds)");
    } else {
        UtilityFunctions::print("[ProgressiveStressTest] Starting test (", duration, " seconds)");
    }
}
...
void ProgressiveStressTest::stop_test() {
    ...
    UtilityFunctions::print("  Duration: ", String::num(elapsed_time, 1), " seconds");
...
int ProgressiveStressTest::get_max_load() const {
    return max_load;
}
...
float ProgressiveStressTest::get_ramp_rate() const {
    return ramp_rate;
}

bool ProgressiveStressTest::get_is_running() const {
    return is_running;
}

bool ProgressiveStressTest::get_is_complete() const {
    return is_complete;
}

float ProgressiveStressTest::get_elapsed_time() const {
    return elapsed_time;
}
...
int ProgressiveStressTest::get_current_load() const {
    return current_load;
}
...
int ProgressiveStressTest::get_peak_load() const {
    return peak_load_achieved;
}
...
String ProgressiveStressTest::get_status() const {
    ...
    if (!is_running && !is_complete) {
        ...
        status += "Load: " + String::num_int64(current_load) + "/" + String::num_int64(max_load);
        status += " (" + String::num(get_load_percentage(), 1) + "%)";
        status += " | Time: " + String::num(elapsed_time, 1) + "/" + String::num(duration, 1) + "s";
    }
...
void ProgressiveStressTest::set_quick_test_mode(bool enabled, float duration) {
    ...
    if (verbose_logging) {
        UtilityFunctions::print("[Verbose] Quick test mode: ", enabled ? "enabled" : "disabled", " (", duration, "s)");
    }
}
