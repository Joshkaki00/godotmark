...
void PerformanceMonitor::_bind_methods() {
    ClassDB::bind_method(D_METHOD("update", "delta"), &PerformanceMonitor::update);
    ClassDB::bind_method(D_METHOD("reset"), &PerformanceMonitor::reset);
    ClassDB::bind_method(D_METHOD("set_verbose_logging", "enabled"), &PerformanceMonitor::set_verbose_logging);
    ClassDB::bind_method(D_METHOD("get_verbose_logging"), &PerformanceMonitor::get_verbose_logging);
    
    // Current values
    ClassDB::bind_method(D_METHOD("get_current_fps"), &PerformanceMonitor::get_current_fps);
    ClassDB::bind_method(D_METHOD("get_current_frametime_ms"), &PerformanceMonitor::get_current_frametime_ms);
    ClassDB::bind_method(D_METHOD("get_temperature"), &PerformanceMonitor::get_temperature);
    ClassDB::bind_method(D_METHOD("get_cpu_usage"), &PerformanceMonitor::get_cpu_usage);
    ClassDB::bind_method(D_METHOD("get_gpu_usage"), &PerformanceMonitor::get_gpu_usage);
    
    // Statistics
    ClassDB::bind_method(D_METHOD("get_avg_fps"), &PerformanceMonitor::get_avg_fps);
    ClassDB::bind_method(D_METHOD("get_min_fps"), &PerformanceMonitor::get_min_fps);
    ClassDB::bind_method(D_METHOD("get_max_fps"), &PerformanceMonitor::get_max_fps);
    ClassDB::bind_method(D_METHOD("get_p1_low_fps"), &PerformanceMonitor::get_p1_low_fps);
    ClassDB::bind_method(D_METHOD("get_p95_frametime_ms"), &PerformanceMonitor::get_p95_frametime_ms);
    ClassDB::bind_method(D_METHOD("get_p99_frametime_ms"), &PerformanceMonitor::get_p99_frametime_ms);
    
    // Thermal
    ClassDB::bind_method(D_METHOD("get_avg_temperature"), &PerformanceMonitor::get_avg_temperature);
    ClassDB::bind_method(D_METHOD("get_max_temperature"), &PerformanceMonitor::get_max_temperature);
    ClassDB::bind_method(D_METHOD("get_throttle_events"), &PerformanceMonitor::get_throttle_events);
    ClassDB::bind_method(D_METHOD("is_throttling"), &PerformanceMonitor::is_throttling);
    
    // Formatted output
    ClassDB::bind_method(D_METHOD("get_performance_summary"), &PerformanceMonitor::get_performance_summary);
}
...
bool PerformanceMonitor::get_verbose_logging() const {
    ...
    for (const char* path : thermal_paths) {
        ...
        if (!temp_str.is_empty()) {
            ...
            if (avg_temperature == 0.0f) {
                ...
                avg_temperature = (avg_temperature * 0.9f) + (current_temperature * 0.1f);
            }
...
void PerformanceMonitor::detect_throttling() {
    ...
    if (is_currently_throttling && !was_throttling) {
        throttle_events++;
        UtilityFunctions::print("[PerformanceMonitor] Thermal throttling detected! Temp: ", 
...
float PerformanceMonitor::get_current_fps() const {
    return current_fps;
}
...
float PerformanceMonitor::get_cpu_usage() const {
    return cpu_usage;
}

float PerformanceMonitor::get_gpu_usage() const {
    return gpu_usage;
}

// Getters - Statistics
float PerformanceMonitor::get_avg_fps() const {
    return avg_fps;
}

float PerformanceMonitor::get_min_fps() const {
    return min_fps;
}

float PerformanceMonitor::get_max_fps() const {
    return max_fps;
}

float PerformanceMonitor::get_p1_low_fps() const {
    return p1_low_fps;
}
...
int PerformanceMonitor::get_throttle_events() const {
